...
const (
	...
	// MessageTypeMCP 模型上下文协议（MCP）消息类型。
	MessageTypeMCP = "mcp"
...
type ClientMessage struct {
	...
	// MCPPayload MCP 载荷（仅在 Kind == KindMCP 时有效）。
	MCPPayload json.RawMessage `json:"payload,omitempty"`
