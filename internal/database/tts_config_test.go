...
func TestTTSConfig_ListAndFilter(t *testing.T) {
	...
	items := []*TTSConfig{
		{Name: "TTS-Alpha", Provider: "dashscope", Endpoint: "wss://alpha.example.com/tts", Model: "m1", Voices: "[]", ConnectTimeoutMS: 5000, SentenceTimeoutMS: 10000, Enabled: true},
		{Name: "TTS-Beta", Provider: "volcengine", Endpoint: "wss://beta.example.com/tts", Model: "m2", Voices: "[]", ConnectTimeoutMS: 5000, SentenceTimeoutMS: 10000, Enabled: true},
		{Name: "TTS-Gamma", Provider: "openai", Endpoint: "wss://gamma.example.com/tts", Model: "m3", Voices: "[]", ConnectTimeoutMS: 5000, SentenceTimeoutMS: 10000, Enabled: false},
	}
