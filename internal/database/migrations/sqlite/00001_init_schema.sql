...
CREATE TABLE IF NOT EXISTS asr_config (
    ...
    provider VARCHAR(64) NOT NULL DEFAULT '',                      -- ASR 服务商/平台：dashscope / volcengine / openai 等
...
CREATE TABLE IF NOT EXISTS llm_config (
    id INTEGER PRIMARY KEY AUTOINCREMENT,                          -- 配置内部自增主键
    name VARCHAR(128) NOT NULL,                                    -- 配置展示名称（非唯一）
    provider VARCHAR(64) NOT NULL DEFAULT '',                      -- LLM 服务商/平台：dashscope / deepseek / kimi / zai 等
...
CREATE TABLE IF NOT EXISTS tts_config (
    id INTEGER PRIMARY KEY AUTOINCREMENT,                          -- 配置内部自增主键
    name VARCHAR(128) NOT NULL,                                    -- 配置展示名称（非唯一）
    provider VARCHAR(64) NOT NULL DEFAULT '',                      -- TTS 服务商/平台：dashscope / volcengine / openai 等
